			...
			if new_style then
				...
				if inBox and justClicked then
					...
					elseif not value.editable then
						...
						friends_message_window = guiCreateWindow( screen_x / 2 - 200, screen_y / 2 - 30, 400, 60, "Atjaunot draugu ziņu", false )
						local e = guiCreateEdit( 5, 25, 290, 30, value.message, false, friends_message_window )
						guiEditSetMaxLength(e,500)
						local c = guiCreateButton( 300, 25, 45, 30, "Saglabāt", false, friends_message_window )
						local d = guiCreateButton( 350, 25, 45, 30, "Atcelt", false, friends_message_window )
				...
				if value.player then
					...
					text = "Pēdējo reiz redzēts\n"..( formatTimeInterval( value.lastOnline ) .. " atpakaļ." ):gsub( "  ", " " )
				end
				...
				if inBox and justClicked then
					...
					elseif not value.editable then
						...
						friends_message_window = guiCreateWindow( screen_x / 2 - 200, screen_y / 2 - 30, 400, 60, "Atjauno savu draugu ziņu", false )
						local e = guiCreateEdit( 5, 25, 290, 30, value.message, false, friends_message_window )
						local c = guiCreateButton( 300, 25, 45, 30, "Saglabāt", false, friends_message_window )
						local d = guiCreateButton( 350, 25, 45, 30, "Atcelt", false, friends_message_window )
						addEventHandler( "onClientGUIClick", c,
