...
function restrainPlayer(player, restrainedObj)
	...
	outputChatBox("Tevi saslēdza/sasēja " .. username:gsub("_", " ") .. ".", player)
	outputChatBox("Tu saslēdzi/sasēji " .. targetPlayerName:gsub("_", " ") .. ".", client)
...
function unrestrainPlayer(player, restrainedObj)
	...
	outputChatBox("Tevi atsēja/atslēdza " .. username:gsub("_", " ") .. ".", player)
	outputChatBox("Tu atsēji/atslēdzi " .. targetPlayerName:gsub("_", " ") .. ".", client)
...
function blindfoldPlayer(player)
	...
	outputChatBox("Tev " .. username .. " aizsēja acis.", player)
	outputChatBox("Tu aizsēji " .. targetPlayerName .. " acis.", client)
...
function removeblindfoldPlayer(player)
	...
	outputChatBox("Tev noņēma acu apsēju " .. username .. ".", player)
	outputChatBox("Tu noņēmi " .. targetPlayerName .. " acu apsēju.", source)
...
function stabilizePlayer(player)
	...
	if found then
		...
		outputChatBox("Tevi nostabilizēja " .. username .. ".", player)
		outputChatBox("Tu nostabilizēji " .. targetPlayerName .. ".", client)
