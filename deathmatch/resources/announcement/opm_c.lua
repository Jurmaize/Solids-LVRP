...
function showOpmTip()
	closeOpmTip()
	GUIEditor.window[2] = guiCreateWindow(607, 304, 449, 280, "Offline Privātā ziņa", false)
...
function startOpm(cmd, username, ...)
	if not username or not (...) then
		...
		GUIEditor.label[1] = guiCreateLabel(20, 33, 50, 26, "Kam:", false, GUIEditor.window[1])
		...
		GUIEditor.label[2] = guiCreateLabel(20, 59, 60, 26, "Ziņa:", false, GUIEditor.window[1])
		guiSetFont(GUIEditor.label[2], "default-bold-small")
		guiLabelSetVerticalAlign(GUIEditor.label[2], "center")
		GUIEditor.label[3] = guiCreateLabel(94, 63, 293, 16, "", false, GUIEditor.window[1])
		guiLabelSetHorizontalAlign(GUIEditor.label[3], "center", false)
		guiLabelSetVerticalAlign(GUIEditor.label[3], "center")
		GUIEditor.button[3] = guiCreateButton(22, 249, 197, 26, "Atcelt", false, GUIEditor.window[1])
		guiSetFont(GUIEditor.button[3], "default-bold-small")
		local cost = 0
		GUIEditor.button[2] = guiCreateButton(219, 249, 197, 26, "Sūtīt"..(cost > 0 and (" ("..cost.." GCs)") or ""), false, GUIEditor.window[1])
		...
		addEventHandler("onClientGUIChanged", GUIEditor.edit[1], function()
        	if source == GUIEditor.edit[1] then
        		...
        		if string.len(text) >= 3 then
	        		local count = 0
	        		guiSetText(GUIEditor.label[3], "Meklē..")
	        		...
	        		timer.username = setTimer(function()
	        			...
	        			if username then
	        				...
	        				guiSetText(GUIEditor.label[3], "Atrada: "..username..".")
	        				...
	        				if count > 4 then
	        					guiSetText(GUIEditor.label[3], "Lietotājs netika atrasts.")
