...
function createDealerNPCs(which)
    ...
    if which == getThisResource() or which == "Nicholas Davis" then
        --outputDebugString("Created")
        dealershipPed[11] = createPed( 101, 161.2001953125, -1905.267578125, 3.7734375 )
        setPedRotation( dealershipPed[11], 80.81 )
    ...
    if which == getThisResource() or which == "Anthony Anderson" then
        --outputDebugString("Created")
        dealershipPed[12] = createPed( 97, 172.2333984375, -1951.7685546875, 3.7734375 )
        setPedRotation( dealershipPed[12], 58.42 )
