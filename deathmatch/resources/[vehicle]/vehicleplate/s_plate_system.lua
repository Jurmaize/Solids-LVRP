...
function pedTalk(state)
	...
	elseif (state == 2) then
		...
		outputChatBox(source, "Tev nepietiek GC, lai aktivizētu šo.", 255,0,0)
	elseif (state == 3) then
	...
	elseif (state == 4) then
		exports.global:sendLocalText(source, "[English] Gabrielle McCoy saka: Nē? Ceru, ka pārdomāsiet. Lai Jums jauka diena!", 255, 255, 255, 10)
	elseif (state == 5) then
		exports.global:sendLocalText(source, " *Gabrielle McCoy sāk rakstīt informāciju iekš datora.", 255, 51, 102)
		exports.global:sendLocalText(source, "[English] Gabrielle McCoy saka: Labi, Jūs esat gatavs doties, es nosūtīšu kādu ārā, lai sačinī to auto nummuru. Lai Jums jauka diena!", 255, 255, 255, 10)
	elseif (state == 6) then
		exports.global:sendLocalText(source, "[English] Gabrielle McCoy saka: Hmmm. Skatoties pēc mūsu datubāzes, šis nummurs ir jau aizņemts.", 255, 255, 255, 10)
	elseif (state == 7) then
		exports.global:sendLocalText(source, "[English] Gabrielle McCoy saka: Atvainojos, bet Jūsu auto nevajag reģistrētus papīrus vai nummuru.", 255, 255, 255, 10)
	elseif (state == 8) then
		exports.global:sendLocalText(source, "[English] Gabrielle McCoy saka: Atvainojos, bet vai Jūs esat šī auto īpašnieks uz papīra?", 255, 255, 255, 10)
	end
end
...
function setNewReg(car)
	...
	if not exports.global:takeMoney(source, data == 1 and 175 or 50) then
		exports.global:sendLocalText(source, "[English] Gabrielle McCoy saka: Vai es varētu saņemt $"..(data == 1 and 175 or 50).." lūdzu?", 255, 255, 255, 10)
	end
