		...
		if (myCommandsWindow == nil) then
			...
			local commands =
			{
				...
				},
				{
					...
					{ "LSAK", "/towtruck", "Calls a towtruck to your current location.", "/towtruck" },
					{ "LSAK", "/resettowbackup", "Removes the blip created with /towtruck.", "/resettowbackup" },
					{ "LSAK", "/impoundbike", "Sets a Bike that is in the impound lot as impounded.", "/impoundbike" },
					{ "LSAK", "/unimpound [vehicle id]", "Sets a vehicle in the HEX Lot and unimpounded.", "/unimpound" },
