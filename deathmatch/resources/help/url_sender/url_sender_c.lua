...
function showUrlSender(url1)
	...
	GUIEditor_Window[1] = guiCreateWindow(left,top,windowWidth,windowHeight,sender.." ir tev atsūtījis URL. Vai tu vēlies to nokopēt?'",false)
	guiWindowSetSizable(GUIEditor_Window[1],false)
	GUIEditor_Edit[1] = guiCreateEdit(10,26,512,30,url,false,GUIEditor_Window[1])
	guiEditSetReadOnly(GUIEditor_Edit[1],true)
	GUIEditor_Button[1] = guiCreateButton(10,67,256,28,"Kopēt (Enter)",false,GUIEditor_Window[1])
	GUIEditor_Button[2] = guiCreateButton(266,67,256,28,"Aizvērt (Backspace)",false,GUIEditor_Window[1])
