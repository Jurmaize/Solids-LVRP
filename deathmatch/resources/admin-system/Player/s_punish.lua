...
function punishPlayer(thePlayer, commandName, target, points, repetitive, ...)
	if exports.integration:isPlayerTrialAdmin( thePlayer ) then
		...
		if currentPoints == 0 or getElementData(targetPlayer, "punishment:date") == nil then
			...
			if not result2 then
				outputChatBox("ERROR: #PUNISH02 - https://discord.gg/S5PDPdDeac", thePlayer, 255, 0, 0)
			end
...
function offlinePunishPlayer(thePlayer, commandName, target, points, repetitive, ...)
	if exports.integration:isPlayerTrialAdmin( thePlayer ) then
		...
		if punishdate == nil then
			...
			if not result2 then
				outputChatBox("ERROR: #PUNISH02 - https://discord.gg/S5PDPdDeac", thePlayer)
			end
		else
		...
		if not currentPoints then
			outputChatBox("ERROR: #PUNISH03 - https://discord.gg/S5PDPdDeac", thePlayer, 255, 0, 0)
			return
