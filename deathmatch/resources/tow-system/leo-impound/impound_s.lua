...
releasePositions = {
	[1] = {
		{ 1524.1845703125, -1625.072265625, 13.080104827881, 0, 0, 357.75823974609 },
		{ 1523.931640625, -1631.79296875, 13.080353736877, 0, 0, 357.23077392578 },
		{ 1523.9091796875, -1638.34375, 13.080885887146, 0, 0, 0.57144165039062 },
		{ 1523.9462890625, -1644.5634765625, 13.077658653259, 0, 0, 359.78021240234 },
		{ 1524.3505859375, -1651.560546875, 13.077279090881, 0, 0, 2.0659484863281 },
		{ 1524.8046875, -1657.712890625, 13.07658290863, 0, 0, 0.21978759765625 },
		{ 1524.705078125, -1664.2646484375, 13.081545829773, 0, 0, 358.9010925293 },
	},
	[50] = {
...
local convos = {
	['nobadge'] = {
		"Var es lūdzu varētu dabūt Jūsu žetonu?",
		"Žetonu lūdzu?",
	},
	['noveh'] = {
        "Kur atrodas Jūsu auto?",
        "Ko Tu vēlies lai es konfiscēju?",
        "Lūdzu ved auto iekšā.",
        "Ved to šurp, lūdzu."
    },
    ['invalid_days'] = {
        "Konfiscēšanas ilgumam jābūt no 1 līdz 500 dienām",
        "Konfiscēšanas laiks ir diez gan liels, tu tā nedomā draudziņ?",
        "Es ceru, ka tas ir joks?",
    },
    ['too_long_info'] = {
        "Emm, papildus info ir pārāk garš, lūdzu samazini burtu skaitu?",
        "Mazāk vārdus draugs, es tik ātri nemāku lasīt",
        "Samazini vārdu skaitu ibio, nav uz lapas tik daudz vietas!",
    },
    ['invalid_lanes'] = {
        "Stāvvieta nummuram jābūt kā ciparam, gudrīt!",
        "Eu, nu saņemies, stāvvietas nummuram jābūt ciparam!",
        "Pozitīvu laukuma nummuru lūdzu!",
    },
    ['lane_not_free_anymore'] = {
        "Atvaino bet stāvvieta ir aizņemta.",
        "OI, laukums aizņemts!",
        "Izvēlies, lūdzu brīvu vietu",
    },
    ['one_car_at_once'] = {
        "Piedod, bet kaut kas nav kārtībā!",
        "Pa vienam auto lūdzu!",
    },
    ['invalid_fine'] = {
        "Sods nedrīkst pārsniegt 50,000, lūdzu samazini cenu kovboj!",
    },
    ['no_car_to_release'] = {
        "Mums pašlaik nav konfiscēts neviens auto.",
        "Piedod, bet es nevarēju atrast nevienu auto, kuru varētu izpirkt.",
        "Neviena no šīm grabažām nav tava brāl!",
    },
    ['select_to_release'] = {
        "Kuru auto vēlies izpirkt?",
        "Kurš auto tad ir tavs?",
        "Nu izvēlies vienu, man dziest saļanka!"
    },
}
...
function release(pedName, vehid, cost)
	...
	local state, reason = unimpVeh(vehid)
	if state then
		exports.global:sendLocalText( source, " [English] "..pedName.." says: "..(getConvoText("Auto veiksmīgi izpirkts, tas gaida priekšā. (( Lūdzu neaizmirstat veikt /park jaunā vietā, savādāk tas iespawnosies atpakaļ konfiscētuves placī. ))")), 255, 255, 255, 10 )
