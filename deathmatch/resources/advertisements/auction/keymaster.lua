...
addEventHandler("keymaster:get-key", resourceRoot, function (auction)
    exports.mysql:getConn('mta'):query(
        function (handle, player)
            ...
            outputChatBox("Tev iedeva tava " .. getVehicleFullName(vehicle) .. " atslēgas.", player, 100, 255, 100)
            outputChatBox("Lūdzu saņemiet savu auto, izsoles ziemeļu pusē.", player, 100, 255, 100)
            outputChatBox("Neaizmirstiet izmantot /park pēc auto saņemšanas!", player, 100, 255, 100)
        end,
        {client},
