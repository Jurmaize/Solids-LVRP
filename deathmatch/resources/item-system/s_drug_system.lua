function mixDrugs(drug1, drug2, drug1name, drug2name)
	...
	if (drugName == nil or drugID == nil) then
		outputChatBox("Error #1000 - Report on https://discord.gg/S5PDPdDeac", client, 255, 0, 0)
		return
	end
	...
	if (given) then
		outputChatBox("Tu sajauci '" .. drug1name .. "' un '" .. drug2name .. "', lai izveidotu '" .. drugName .. "'", client)
		exports.global:sendLocalMeAction(client, "sajauc pāris vielas kopā.")
	else
		outputChatBox("Tev nav pietiekami vietas kabatās, lai sajauktu šīs divas lietas kopā.", client, 255, 0, 0)
