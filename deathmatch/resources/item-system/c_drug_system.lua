...
addEvent("triggerDrug1Effect",true)
addEventHandler("triggerDrug1Effect", localPlayer, doDrug1Effect)
...
addEvent("triggerDrug2Effect",true)
addEventHandler("triggerDrug2Effect", localPlayer, doDrug2Effect)
...
addEvent("triggerDrug3Effect",true)
addEventHandler("triggerDrug3Effect", localPlayer, doDrug3Effect)
...
addEvent("triggerDrug4Effect",true)
addEventHandler("triggerDrug4Effect", localPlayer, doDrug4Effect)
...
addEvent("triggerDrug5Effect",true)
addEventHandler("triggerDrug5Effect", localPlayer, doDrug5Effect)
...
addEvent("triggerDrug6Effect",true)
addEventHandler("triggerDrug6Effect", localPlayer, doDrug6Effect)

local drugMessages = { "Pis suni pipar!", "Ej diiiirst! Tu lidoooo!", "Mums vajag biku to pūūūūderīīīt!", "Vecais labais viens divi pisiens pa seju!", "Eyo, kāpēc tev kājas ir selerija kociņi?", "Gribi dejot peģik?", "Euu, es arī grib nedaudz to mantiņ?", "Eu, es zvanīs kruķiem." }
	...
	for key, value in ipairs(players) do
		if (value~=localPlayer) then
			...
			if (getDistanceBetweenPoints3D(x, y, z, px, py, pz)<15) then
				...
				outputChatBox(charname .. " Saka: " .. drugMessages[rand2], 255, 255, 255)
				break
			end
		end
	end
