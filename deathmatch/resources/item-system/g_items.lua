g_items = {
	...
	[242] = { "Workbench", "A good workbench!", 4, 936, 0, 0, 0, 0, weight = 4, storage = true, capacity = 20 }, --Exciter, factory system --preventSpawn = true
	...
	[244] = { "Oven", "Oven that can be used to cook stuff.", 4, 2417, 0, 0, 0, 0, weight = 4, storage = true, capacity = 10 }, --Exciter, factory system --preventSpawn = true
