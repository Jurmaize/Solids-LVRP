function startBook(id, slot)
	if not tonumber(id) then
		outputChatBox("Error, BK#01. Report on https://discord.gg/S5PDPdDeac", client, 255, 0, 0)
		return
	end
	...
	if query then
		...
		if row then
			...
			triggerClientEvent(client, "PlayerBook", client, false, false, "Error, BK#02: Issue fetching book data! Report @ https://discord.gg/S5PDPdDeac")
		end
	else
		triggerClientEvent(client, "PlayerBook", client, false, false,"Error, BK#03: Issue Running SQL Query! Report @ https://discord.gg/S5PDPdDeac")
	end
