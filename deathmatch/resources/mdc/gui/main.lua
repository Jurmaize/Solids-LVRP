...
function main ( warrants, apb, impounds, calls, anpr )
	closeMainW()
	--outputChatBox( "Experimental MDC system! Any feedback or bugs you find within this system please let us know via https://discord.gg/S5PDPdDeac/view.php?id=616 ASAP.", 255, 0, 0 )
	...
	for i, oneLane in pairs(impounds) do
		...
		guiGridListSetItemText( mainW.imps_lots_list, row, mainW.imps_lots_list_col_dep, oneLane.impounder == 1 and "LSPD" or oneLane.impounder == 50 and "SCoSA" or "LSAK", false, false )
