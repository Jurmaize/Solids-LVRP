...
function onLicenseServer()
	...
	if (gender == 0) then
		exports.global:sendLocalText(source, "Carla Cooper says: Labdien, vai Jūs vēlētos pieteikties tiesībām?", 255, 255, 255, 10)
	else
		exports.global:sendLocalText(source, "Carla Cooper says: Labdien, vai Jūs vēlētos pieteikties tiesībām?", 255, 255, 255, 10)
	end
end
...
function payFee(amount, reason)
	if exports.global:takeMoney(source, amount) then
		...
		exports.hud:sendBottomNotification(source, "CSDD", "Jūs esat samaksājis $"..exports.global:formatMoney(amount).." par "..reason..".")
	end
end
