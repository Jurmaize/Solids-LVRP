...
function options_showmenu()
	...
	bChangeCharacter = guiCreateButton(margin, margin, 230, 30, "Mainīt personāžu", false, wOptions)
	...
	bStatistics = guiCreateButton(margin, wHeight, 230, 30, "Personāža statistika", false, wOptions)
	...
	bGraphicsSettings = guiCreateButton(margin, wHeight, 230, 30, "Opcijas", false, wOptions)
	...
	if getResourceFromName("donators") then
		bStore = guiCreateButton(margin, wHeight, 230, 30, "Ziedotāju bonusi", false, wOptions)
		--addEventHandler("onClientGUIClick", bGraphicsSettings, options_opengraphicsmenu, false)
	...
	if getResourceFromName("admin-system") and exports['admin-system']:canPlayerAccessStaffManager(localPlayer) then
		bStaffManager = guiCreateButton(margin, wHeight, 230, 30, "Administrācijas pārskats", false, wOptions)
	...
	if getResourceFromName("factions") and exports.factions:canAccessFactionManager( localPlayer ) then
		bFactionManager = guiCreateButton(margin, wHeight, 230, 30, "Frakciju pārskats", false, wOptions)
	...
	if getResourceFromName("interior_system") and getResourceFromName("interior-manager") and exports.integration:isPlayerAdmin( localPlayer ) then
		bInteriorManager = guiCreateButton(margin, wHeight, 230, 30, "Interjeru pārskats", false, wOptions)
	...
	if getResourceFromName("vehicle") and getResourceFromName("vehicle_manager") and exports.vehicle_manager:canAccessVehicleManager( localPlayer ) then
		bVehicleManager = guiCreateButton(margin, wHeight, 230, 30, "Automašīnu pārskats", false, wOptions)
	...
	if getResourceFromName('vehicle') and getResourceFromName("vehicle_manager") then
		...
		if exports.integration:isPlayerVCTMember(thePlayer) or exports.integration:isPlayerSupporter(thePlayer) or exports.integration:isPlayerTrialAdmin(thePlayer) or exports.integration:isPlayerScripter(thePlayer) or exports.integration:isPlayerVehicleConsultant(thePlayer) then
			bVehicleLib = guiCreateButton(margin, wHeight, 230, 30, "Automašīnu bibliotēka", false, wOptions)
	...
	if getResourceFromName("apps") and exports.integration:isPlayerTrialAdmin(localPlayer) or exports.integration:isPlayerSupporter(localPlayer) then
		bApplicationManager = guiCreateButton(margin, wHeight, 230, 30, "Applikāciju pārskats", false, wOptions)
	...
	if getResourceFromName("carradio") then
		bRadioManager = guiCreateButton(margin, wHeight, 230, 30, "Radio staciju pārskats", false, wOptions)
	...
	if getResourceFromName("announcement") and exports.announcement:canPlayerAccessMotdManager(localPlayer) then
		bmotd = guiCreateButton(margin, wHeight, 230, 30, "Dienas ziņu pārskats", false, wOptions)
	...
	if getResourceFromName("map_manager") then
		bHelp = guiCreateButton(margin, wHeight, 230, 30, "Mappingu pārskats", false, wOptions)
	...
	bLogout = guiCreateButton(margin, wHeight, 230, 30, "Izrakstīties", false, wOptions)
	...
	bClose = guiCreateButton(margin, wHeight, 230, 30, "Aizvērt", false, wOptions)
...
function options_opengraphicsmenu()
	...
	wGraphicsMenu = guiCreateWindow(left, top, windowWidth, windowHeight, "Spēles opcijas", false)
	...
	bGraphicsMenuClose = guiCreateButton(10, 320, 490, 17*2, "Aizvērt", false, wGraphicsMenu)
