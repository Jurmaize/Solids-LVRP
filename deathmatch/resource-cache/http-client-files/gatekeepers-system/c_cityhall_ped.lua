...
function popupJesPedMenu()
	...
	local l1 = guiCreateLabel(0, 0.08, 1, 0.25, "Kā varu palīdzēt?", true, vmOptionMenu)
	guiLabelSetHorizontalAlign(l1, "center")
	local bJob = guiCreateButton(0.05, 0.3, 0.87, 0.18, "Vēlos pieteikties darbam", true, vmOptionMenu)
	addEventHandler("onClientGUIClick", bJob, bJobF, false)

	local bID = guiCreateButton(0.05, 0.5, 0.87, 0.18, "Man vajag jaunu ID karti. ($5)", true, vmOptionMenu)
	addEventHandler("onClientGUIClick", bID, newIDCard, false)

	local bSomethingElse = guiCreateButton(0.05, 0.7, 0.87, 0.18, "Neko.", true, vmOptionMenu)
