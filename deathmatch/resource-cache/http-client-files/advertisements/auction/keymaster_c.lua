local KEYMASTER_POSITION = Vector3(1270.7587890625, -1645.6875, 13.63875)
local KEYMASTER_ROTATION = 249
...
addEventHandler("keymaster:create-menu", root, function (keysAvailable)
    ...
    for _, auction in pairs(keysAvailable) do
        local row = exports.rightclick:addRow("Saņemt " .. auction.vehicle_name .. " atslēgu")
