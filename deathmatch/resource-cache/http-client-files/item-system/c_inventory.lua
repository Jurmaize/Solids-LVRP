...
local actionIcons =
{
	[TAB_WALLET] = { -48, tocolor( 255, 255, 255, 50 ), "Maks" },
	[TAB_ITEMS] = { 48, tocolor( 255, 255, 255, 50 ), "Mantas" },
	[TAB_KEYS] = { -203, tocolor( 255, 255, 255, 50 ), "Atslēgas" },
	[TAB_WEAPONS] = { -204, tocolor( 255, 255, 255, 50 ), "Ieroči" },
	
	[ACTION_DROP] = { -202, tocolor( 127, 255, 127, 63 ), "Nomest mantu", "Turi CTRL, kamēr turi mantu, lai to ātri nomestu." },
	[ACTION_SHOW] = { -201, tocolor( 127, 127, 255, 63 ), "Parādīt mantu" },
	[ACTION_DESTROY] = { -200, tocolor( 255, 127, 127, 63 ), "Iznīcināt mantu", "Turi DELETE, kad izvēlies mantu, lai to ātri iznīcinātu." },
					...
					if state == "up" and clickItemSlot then
						...
						elseif not clickItemSlot.group then
							...
							elseif hoverAction == ACTION_SHOW then
								...
								if item[1] == 72 then
									itemName = itemName .. ", lasot " .. itemValue
								...
								elseif item[1] == 133 or item[1] == 153 or item[1] == 154 or item[1] == 155 or item[1] == 78 then--Cards
									itemName = itemName .. ", izdota priekš "..itemValue..""
								elseif item[1] == 150 then--ATM card
									...
									itemName = itemName .. ", izdota priekš "..owner
							...
							elseif hoverAction == ACTION_DESTROY then
								...
								if itemID == 48 and countItems( localPlayer, 48 ) == 1 then -- backpack
									if getCarriedWeight( localPlayer ) - getItemWeight( 48, 1 ) > 10 then
										outputChatBox("Jums ir pārāk daudz mantu kabatās.")
									else
										triggerServerEvent( "destroyItem", localPlayer, itemSlot )
									end
								elseif itemID == 134 then --Money
									outputChatBox("Tu nevari iznīcināt naudu.")
								else
									triggerServerEvent( "destroyItem", localPlayer, itemSlot )
								end
