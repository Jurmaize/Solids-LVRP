...
waterSourcesAmount = { -- amount each watering item gives to weed plants.
	[15] = 45,
	[9] = 25,
	[58] = 35,
	[62] = 35,
...
5. Call to individual script .lua for that drug. For weed, it's c_weed.lua and s_weed.lua etc. add harvesting for that specific drug
6. Add new entry to switch in c_base.lua to call that specific drugs menu.
]]

--[[
How to make cocaine:
1. Take coco seed. and plant it.
2. Water coco plant.
3. Harvest coca plant to get coca leaves.


4. Place coca leaves in barrel - ir
5. crush coca leaves - ir
6. add cement powder - ir
7. add water - ir
8. add petrol - ir
9. sulfuric acid / drain cleaner - ir
]]